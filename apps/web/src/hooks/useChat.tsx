...
export const useChat = (chatRoomId: number) => {
  ...
  const [messages, setMessages] = useState<CreateMessageResponseType[]>([]);
  ...
  useEffect(() => {
    ...
    const handleNewMessage = (message: CreateMessageResponseType) => {
  ...
  const sendMessage = useCallback(
    (content: string) => {
      ...
      const messageData: CreateMessageRequestType = {
        chatRoomId,
